...
export default function Nav({ variant, trans }: { variant?: 'white' | 'blue' | 'white-trans'; trans?: boolean }) {
			...
			>
				<div className='container mx-auto flex items-center justify-between'>
					...
					>
						...
						<Navlink variant={variant} show={show} To={'/ukm'}>
							UKM
						</Navlink>
						<a href={'/rajaapps'} target='_blank'>
							...
							<button
								className={`lg:hidden bg-yellow bg-trans border-2  ${
									variant == 'white' && !show ? 'text-blue border-blue' : 'text-white border-white'
					...
					<div>
						<a href={'/rajaapps'} target='_blank'>
							...
							<button
								className={`hidden lg:block bg-trans border-2 ${
									variant == 'white' ? 'text-blue border-blue' : 'text-white border-white'
								} py-2 px-4 normal-case font-agrandir rounded-lg whitespace-nowrap`}
							>
								RAJA Apps
							</button>
						</a>
