				...
				<div className='container mx-auto flex items-center justify-between'>
					...
					>
						...
						<Link href={"/apps"}>
							...
							<button
								className='lg:hidden bg-yellow bg-trans border-2 border-white text-white py-2 px-4 normal-case font-agrandir rounded-lg'
							>
								Raja Apps
							</button>
						</Link>
					...
					<div>
						<Link href={"/apps"}>
							...
							<button
								className='hidden lg:block bg-trans border-2 border-white text-white py-2 px-4 normal-case font-agrandir rounded-lg'
							>
								Raja Apps
							</button>
						</Link>
