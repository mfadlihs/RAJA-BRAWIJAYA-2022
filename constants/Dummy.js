...
export const AtributData = isMan => {
	const Cowok = [
		{
			text:
				"Rambut tidak boleh dicat, harus dipotong pendek, tidak bermodel skin hairstyle, rapi dan tidak melebihi leher, telinga, maupun alis.",
		},
		{
			text:
		...
		{
			text:
				"Memakai celana panjang berwarna hitam berbahan kain (bukan berbahan kaos ataupun jeans) rapi, tidak ketat, tidak transparan, tidak bermotif bukan cutbray atau skinny.",
		},
		{
		...
		{
			text:
				"Memakai ikat pinggang berwarna hitam polos dengan mata gesper yang tidak besar dan mencolok.",
		},
		{
		...
		{
			text:
				"Memakai kaos kaki berwarna putih tidak transparan, polos dengan tinggi minimal 10 cm diatas mata kaki.",
		},
		{
		...
		{
			text:
				"Memakai nametag serta membawa kartu kendali kesehatan selama kegiatan RAJA BRAWIJAYA berlangsung",
		},
		{
			text:
				"Bagi mahasiswa baru yang memiliki penyakit kronis seperti jantung, paru-paru, maag kronis, dll wajib menyematkan pita berwarna hitam pada bagian kiri lengan.**",
		},
		{
		...
		{
			text:
				"Untuk maba difable menggunakan pita berwarna hijau yang disematkan pada bagian kiri lengan",
		},
	];
	const Cewek = [
		{
			text:
				"Tidak berjilbab : <br/>Rambut ditata rapi tidak boleh di cat. harus dikuncir satu model ekor kuda (kuncir rambut berwarna hitam) tanpa poni. diperbolehkan memakai jepit berwarna putih. ",
		},
		{
			text:
				"Berjilbab : <br/> Memakai jilbab berwarna hitam segiempat simetris. tidak transparan. tidak bermotif. tidak berenda. tanpa aksesoris tambahan kecuali peniti ataupun jarum pentul.  ",
		},
		{
			text:
				"Semua Maba Perempuan : <br/> Memakai kemeja lengan panjang berwarna putih polos berkerah berbahan kain (bukan berbahan kaos ataupun jeans). rapi. tidak ketat. tidak bermotif. dan tidak transparan.  ",
		},
		{
			text:
				"Memakai rok panjang berwarna hitam polos berbahan kain (bukan berbahan kaos ataupun chiffon). rapi. tidak ketat. tidak transparan. tidak bermotif dan tanpa belahan. (rok wiru/ramplel)",
		},
		{
			text:
				"Bagi yang sedang berhalangan memakai pita berwarna merah dan disematkan pada bagian kiri lengan (tidak berjilbab). di sematkan pada bagian dada kiri (berjilbab).",
		},
		{
		...
		{
			text:
				"Memakai nametag serta membawa kartu kendali kesehatan selama kegiatan RAJA BRAWIJAYA berlangsung (terlampir)",
		},
		{
			text:
				"Bagi Mahasiswa baru yang memiliki penyakit kronis seperti jantung. paruparu. maag kronis dan lain-lain wajib menyematkan pita warna hitam pada bagian kiri lengan (tidak berjilbab) di sematkan pada bagian dada kiri (berjilbab).",
		},
		{
